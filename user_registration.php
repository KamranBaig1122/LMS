...
if(isset($_SESSION['user_id'])&&$flag==true)
{
...
if(isset($_POST["register_button"]))
{
	...
	if($message == '')
	{
		...
		else
		{
			...
			$query = "INSERT INTO lms_user (user_name, user_address, user_contact_no, user_profile, user_email_address, user_password, user_verification_status, user_unique_id, user_status, user_created_on) 
			...
			$statement->execute($data);
			$flag=true;
            $success = 'Your Registration is Completed Now You can LOG IN to your Account';
		}
