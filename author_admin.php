...
if(isset($_POST["add_author"]))
{
	...
	if($error == '')
	{
		...
		else
		{
			...
			header('location:../author_admin.php?msg=add');
		}
	}
}
...
if(isset($_POST["edit_author"]))
{
	...
	if($error == '')
	{
		...
		else
		{
			...
			header('location:../author_admin.php?msg=edit');
		}
	}
}
...
if(isset($_GET["action"], $_GET["code"], $_GET["status"]) && $_GET["action"] == 'delete')
{
	...
	header('location:../author_admin.php?msg='.strtolower($status).'');
}
...
<div class="container-fluid py-4" style="min-height: 700px;">
	...
	<ol class="breadcrumb mt-4 mb-4 bg-light p-2 border">
        ...
        <li class="breadcrumb-item"><a href="author_admin.php">Author Management</a></li>
		...
		<div class="card-header">
			<div class="row">
				...
				<div class="col col-md-6" align="right">
					<a href="author_admin.php?action=add" class="btn btn-success btn-sm">Add</a>
				</div>
			</div>
		</div>
		<div class="card-body">
				...
				if($statement->rowCount() > 0)
				{
					foreach($statement->fetchAll() as $row)
					{
						...
						<tr>
							...
							<td>
								<a href="author_admin.php?action=edit&code='.convert_data($row["author_id"]).'" class="btn btn-sm btn-primary">Edit</a>
	...
	<script>
		...
		function delete_data(code, status)
		{
			...
			{
				window.location.href = "author_admin.php?action=delete&code="+code+"&status="+new_status+"";
			}
		}
