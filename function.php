...
function Count_total_location_rack_number($connect)
{
	...
	$query = "SELECT COUNT(location_rack_id) AS Total FROM lms_location_rack 
...
function Count_total_category_number($connect)
{
	...
	$query = "SELECT COUNT(category_id) AS Total FROM lms_category WHERE category_status = 'Enable'";
...
function Count_total_author_number($connect)
{
	...
	$query = "SELECT COUNT(author_id) AS Total FROM lms_author WHERE author_status = 'Enable'";
...
function Count_total_book_number($connect)
{
	...
	$query = "SELECT COUNT(book_id) AS Total FROM lms_book WHERE book_status = 'Enable'";
...
function Count_total_fines_received($connect)
{
	...
	$query = "SELECT SUM(book_fines) AS Total FROM lms_issue_book WHERE book_issue_status = 'Return'";
...
function Count_total_not_returned_book_number($connect)
{
	...
	$query = "SELECT COUNT(issue_book_id) AS Total FROM lms_issue_book WHERE book_issue_status = 'Not Return'";
...
function Count_total_returned_book_number($connect)
{
	...
	$query = "SELECT COUNT(issue_book_id) AS Total FROM lms_issue_book WHERE book_issue_status = 'Return'";
...
{
	$output = 0;
	$query = "SELECT library_one_day_fine FROM lms_setting LIMIT 1";
	$result = $connect->query($query);
	foreach($result as $row)
	{
...
function get_total_book_issue_day($connect)
{
	...
	$query = "SELECT library_total_book_issue_day FROM lms_setting LIMIT 1";
...
function get_total_book_issue_per_user($connect, $user_unique_id)
{
	...
	$query = "SELECT COUNT(issue_book_id) AS Total FROM lms_issue_book WHERE user_id = '".$user_unique_id."' AND book_issue_status = 'Issue'";
...
{
	$output = '';
	$query = "SELECT library_issue_total_book_per_user FROM lms_setting LIMIT 1";
	$result = $connect->query($query);
	foreach($result as $row)
	{
...
{
	$output = '';
	$query = "SELECT library_currency FROM lms_setting LIMIT 1";
	$result = $connect->query($query);
	foreach($result as $row)
	{
...
{
	$query = "SELECT category_name FROM lms_category WHERE category_status = 'Enable' ORDER BY category_name ASC";
...
{
	$query = "SELECT location_rack_name FROM lms_location_rack WHERE location_rack_status = 'Enable' ORDER BY location_rack_name ASC";
...
{
	$query = "SELECT library_timezone FROM lms_setting LIMIT 1";
